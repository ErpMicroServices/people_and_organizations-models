package erp_microservices.people_and_organizations.models.party.model.contactmechanism;

import erp_microservices.people_and_organizations.models.party.model.PartyPostalAddress;
import erp_microservices.people_and_organizations.models.party.model.geographic_boundary.GeographicBoundary;
...
public class PostalAddress extends ContactMechanism {
	...
	/**
	 * @param locationFor the locationFor to set
	 */
